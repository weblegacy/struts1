...
<logic:messagesPresent>
   ...
   <html:messages id="error">
    ...
    -->
    <html:form action="upload-submit-multi.do?queryParam=Successful" enctype="multipart/form-data">
    ...
    <html:file property="theFile"  errorStyle="background-color: yellow" multiple="true" /></p>
