 ...
 *     <p><img src="doc-files/image001.png" height="169" width="145" alt="doc-files/image001"></p>
 ...
 *         can then be accessed by their names.</p>
 *
 ...
 *           the definition factory and passes it a configuration object populated
 ...
 * <ul>
 *   <li>Check each Tiles separately. Try to access nested Tiles directly to test
 *   if this work properly.</li>
